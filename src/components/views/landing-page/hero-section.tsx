...
function HeroSection() {
    return (
        <Layouts className='space-y-24 pb-20'>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                <div className="space-y-6 text-center lg:text-left order-2 lg:order-1">
                    <h1 className="text-4xl sm:text-6xl lg:text-5xl xl:text-6xl font-bold text-foreground leading-tight">
                        Start Healing by Talking
                    </h1>
                    <p className="text-base sm:text-lg text-muted-foreground font-poppins leading-relaxed max-w-lg mx-auto lg:mx-0">
                ...
                <div className="flex justify-center order-1 lg:order-2 font-poppins">
                    <div className="relative">
                        <Image
                            ...
                            width={500}
                            height={500}
                            className="w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 xl:w-[500px] xl:h-[500px] object-contain"
                            priority
                        />
                    </div>
                </div>
