            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="md:col-span-3 space-y-6">
                    ...
                    <div className='grid md:grid-cols-3 gap-6'>
                        ...
                        {/* Promo / Upgrade Akun */}
                        <Card className="bg-gradient-to-br from-[#f5786a]/20 to-[#f5786a]/40 border-0 overflow-hidden relative">
                            <div className="absolute -right-8 -top-8 w-24 h-24 opacity-20">
                                <div className="w-full h-full bg-primary rounded-full blur-3xl"></div>
                            </div>
